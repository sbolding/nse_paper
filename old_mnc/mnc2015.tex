...
Hists./Step     & IMC & HOLO-ECMC  &  IMC & HOLO-ECMC   \\ \hline
   12,000	    & 3.63\%  & 0.011\% &  1      &   104,000      \\
  100,000       & 1.96\%  & 0.0033\% & 1.03   &   360,000      \\ \hline
\end{tabular}
\end{table}
...
Table~\ref{marshak_table} compares total CPU simulation time and the average
simulation time per history performed, for IMC and the HOLO method
with ECMC.  The average time per history is computed by dividing the total simulation time by
the total number of histories performed.  Results are given for different numbers of histories per time step, as
...
Hists./Step   & HOLO-SMC & HOLO-RMC & HOLO-ECMC  & HOLO-SMC & HOLO-RMC & HOLO-ECMC   \\ \hline
   12,000	  & 5.35\%   & 0.002953\% & 0.011\%  & 0.46     & 1.51$\times10^6$   & $1.04\times10^4$          \\
...
Hists./Step   & HOLO-SMC & HOLO-RMC & HOLO-ECMC  & HOLO-SMC & HOLO-RMC & HOLO-ECMC   \\ \hline
   ...
   30,000	  & 0.54\%   & 0.08\% & 0.15\% & 0.99   & 48  & 13       \\
  100,000     & 0.16\%   & 0.042\% & 0.08\% & 3.32   & 52  & 15       \\
  100,000 (AMR) & --  & --  & 0.038\% & -- & -- &   61               \\ \hline
\end{tabular}
\end{table}
