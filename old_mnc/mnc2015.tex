...
positive, after each batch. This is done such that we preserve the calculated cell average and preserve the ratio of the
first moment in $\mu$ to the first moment in $x$.  Any negative averages are set to
the floor temperature, i.e., the initial temperature of the simulation.  Although the modified solution is
...
\Subsection{Comparison of Standard MC and ECMC HO Solvers}
...
\Subsection{Comparison of RMC and ECMC HO Solvers}
