...
additional closure in $T$. The final LO equations can be found in Appendix??? 
...
adjusted as $w(x) = w(x_0)\exp(-\sigma|(x-x_0)/\mu|)$, where $x_0$ is the starting location of the path.  The tallies account
