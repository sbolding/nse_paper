...
Eq.~\eqref{ho_trans} and Eq.~\eqref{eq:lo_mat}, formed over a spatial finite element
...
%moments.
Because there are no derivatives of the $T$ in Eq.~\eqref{lo_mat}, there is no need
...
exact solution~\cite{jake,ans_2014}. For TRT problems where absorption-reemission
physics dominate, the diffusive and slowly varying
